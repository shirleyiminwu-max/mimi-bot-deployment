...
if [ -f "/home/runner/work/mimi-bot-deployment/mimi-bot-deployment/templates/SOUL.md" ]; then
    ...
    curl -s "https://raw.githubusercontent.com/shirleyiminwu-max/mimi-bot-deployment/main/templates/SOUL.md" -o "$HOME/.openclaw/workspace/SOUL.md" 2>/dev/null || cat > "$HOME/.openclaw/workspace/SOUL.md" << 'EOF'
# Mimi 的靈魂 🌟
...
if [ -f "/home/runner/work/mimi-bot-deployment/mimi-bot-deployment/templates/IDENTITY.md" ]; then
    ...
    curl -s "https://raw.githubusercontent.com/shirleyiminwu-max/mimi-bot-deployment/main/templates/IDENTITY.md" -o "$HOME/.openclaw/workspace/IDENTITY.md" 2>/dev/null || cat > "$HOME/.openclaw/workspace/IDENTITY.md" << 'EOF'
# Mimi 的身份檔案 🆔
...
if [ -f "/home/runner/work/mimi-bot-deployment/mimi-bot-deployment/templates/CALENDAR.md" ]; then
    ...
    curl -s "https://raw.githubusercontent.com/shirleyiminwu-max/mimi-bot-deployment/main/templates/CALENDAR.md" -o "$HOME/.openclaw/workspace/CALENDAR.md" 2>/dev/null || cat > "$HOME/.openclaw/workspace/CALENDAR.md" << 'EOF'
# 📅 Mimi 的日曆
...
if [ -f "/home/runner/work/mimi-bot-deployment/mimi-bot-deployment/templates/daily_briefing.sh" ]; then
    ...
    curl -s "https://raw.githubusercontent.com/shirleyiminwu-max/mimi-bot-deployment/main/templates/daily_briefing.sh" -o "$HOME/daily_briefing.sh" 2>/dev/null || cat > "$HOME/daily_briefing.sh" << 'EOFSCRIPT'
#!/bin/bash
set -e
